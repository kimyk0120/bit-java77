...
<body>
	...
	<c:if test="${(currPage-1)!=0 }">
		<a href="list.do?page=${currStartPage-1 }">&lt;</a>
	</c:if>
	...
	<c:if test="${currLastPage<lastPage }">
		<a href="list.do?page=${currLastPage+1 }">&gt;</a>
	</c:if>
	<c:if test="${currLastPage<lastPage }">
		<a href="list.do?page=${lastPage }">&gt;&gt;</a>
	</c:if>
	<hr/>
	<input type="button" value="글쓰기" onclick="document.location.href='regist.do'"/>
	</div>
</body>
</html>